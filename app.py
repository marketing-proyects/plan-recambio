...
# --- PESTAÑA 3: PEDIDO ---
    ...
    if st.session_state.carrito:
        ...
        def generate_pdf():
            ...
            total_lista_original = 0
            for it in st.session_state.carrito:
                sb = it['precio'] * (1 - it['dto']/100)
                total_lista_original += it['precio'] # Sumamos los precios de lista
