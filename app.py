...
if st.session_state.tab_actual == "CALCULADORA":
    ...
    with ca:
        ...
        total_u = qc + qs + qb
        st.markdown(f'<div><b>Unidades Entregadas</b><b>Puedes adquirir esta misma cantidad de herramientas con el descuento</b><div class="small-num">{total_u}</div></div>', unsafe_allow_html=True)
    with cb:
