...
st.markdown(f"""
    ...
    /* OCULTAR ICONOS DE ENLACE / CLIP / ANCHORS EN TEXTOS */
                ...
                with cs:
                    ...
                    if st.session_state.dto_base < 20:
                        ...
                        if num_en_carro >= 3:
                            ...
                            dto_item = 20
                            st.info(f"Faltan {max(0, faltantes)} unidad(es) para el 30%.")
...
# --- PESTAÑA 3: PEDIDO ---
    ...
    if st.session_state.carrito:
        ...
        def generate_pdf():
            pdf = FPDF()
            pdf.set_auto_page_break(auto=False) # Para controlar el pie de página manualmente
            pdf.add_page()
            ...
            # Nota al pie fija al final de la primera página
            pdf.set_y(270)
